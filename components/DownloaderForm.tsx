...
export default function DownloaderForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        "Invalid format. Make sure you copy the entire link (https://...).",
      );
      return;
    }
    ...
    try {
      ...
      setResult({
        ...
        thumbnail:
          data.data.thumbnail ||
          "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?auto=format&fit=crop&q=80&w=640&h=360",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{ margin: "0 0.25rem", whiteSpace: "nowrap" }}
            title="Paste Link"
          >
            Paste
          </button>
      ...
      {result && (
        <div
          className="result-container flex flex-col items-center"
          style={{
            marginTop: "3rem",
            padding: "2rem",
            background: "var(--card-bg)",
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ flex: "2 1 250px", gap: "1rem", textAlign: "left" }}
            >
              <p
                style={{
                  fontWeight: 700,
              ...
              <div className="flex flex-col gap-2">
                {result.qualityOptions.map((q: any, i: number) => (
                  <a
                    key={i}
                    href={`/api/proxy?url=${encodeURIComponent(q.url)}&ext=${q.ext}`}
                    download
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn btn-secondary flex justify-between"
                    style={{
                      width: "100%",
                      padding: "0.8rem 1rem",
                  ...
                  >
                    <span style={{ fontWeight: 600 }}>
                      {q.resolution} - {q.ext.toUpperCase()}
                    </span>
                    <span>Download 📥</span>
                  </a>
                ))}
